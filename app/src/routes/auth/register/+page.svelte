<script lang="ts">
  import { load, register } from "./register.remote";
  ...
  <div class="bg-[rgba(196,74,137,0.8)] rounded-full w-150 h-160">
    ...
    <div class="bg-white mx-24 my-4 rounded-box">
      ...
      >
        ...
        >
          <!-- <span hidden>{(toast.value = register.result?.error ? register.result.detail : null)}</span> -->
          ...
          <div class="flex flex-col space-y-2 justify-center items-center">
            ...
            <a href="/auth/login" class="link link-hover mx-4 mt-2 mb-4 text-sm"
              >Login</a
            >
          </div>
        </form>
