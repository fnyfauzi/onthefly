    ...
    onMount(async () => {
      ...
      */
      ...
      type typeBody = {
        ...
        mesh: THREE.Mesh<THREE.IcosahedronGeometry>;
        rigid: RigidBody;
      ...
      metaballs.userData = {
        update() {
          ...
          bodies.forEach((b) => {
            ...
            const bColor: THREE.Color = (
              b.mesh.material as THREE.MeshPhysicalMaterial
            ).color;
            metaballs.addBall(x, y, z, strength, subtract, bColor);
          });
          metaballs.update();
        },
      };
      ...
      //     pointer.copy(intersects[0].point);
      //   }
      // }
