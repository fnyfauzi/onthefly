<script lang="ts">
  ...
  let link: string = `${baseUrl}/protected/similarity/parallel/show-3d`;
  ...
  let linkPdbs = $derived.by(() => {
    return Number(data.offset) === 0
      ? `/similarity/parallel/${data.key}/pdbs`
      : `/similarity/parallel/${data.key}/pdbs-next-prev`;
  });
...
<div class="grid grid-cols-2 gap-0.5 h-screen w-full">
  <div id="demo1" class="flex place-content-center m-0 overflow-hidden">
    ...
    <a
      target="_blank"
      href={`${baseUrl}/protected/similarity/parallel/collision?key=${data.key}&name=${data.name}&offset=${data.offset}&limit=${data.limit}`}
    ...
    <a
      target="_blank"
      href={`${baseUrl}/protected/similarity/parallel/reaction?key=${data.key}&name=${data.name}&offset=${data.offset}&limit=${data.limit}`}
  ...
  <div id="demo2" class="flex place-content-center m-0 overflow-hidden">
    ...
    <!-- <a
      target="_blank"
      href={`${baseUrl}/protected/similarity/parallel/collision?key=${data.key}&name=${data.name}&offset=0&limit=16`}
      class="absolute w-full/2 left-[calc(50%+1.2em)] top-2 btn btn-lg bg-white text-black"
      >Collision</a
    > -->
    <a
      target="_blank"
      href={`${baseUrl}/protected/similarity/parallel/cubemap?offset=${data.offset}&subDir=${data.key}&file=${fileSelected}`}
      class="absolute w-full/2 right-[1.2em] top-2 btn btn-lg bg-white text-black"
      >Realistic</a
    >
    <!-- name -->
